            ...
            <div class="form-comments">
              ...
              <form class="form-a" action="usercontroller/addserv.php" method="post" enctype="multipart/form-data">
                <div class="row">
                 ...
                 <div class="col-md-6 mb-3">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control form-control-lg form-control-a" id="inputEmail1" placeholder="Enter Amount You Charge For Service *" name="charge" required>
                    </div>
                  </div>
                 ...
                 <div class="col-md-6 mb-3">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control form-control-lg form-control-a" id="inputEmail1" placeholder="Enter Time Taken For Service *" name="time" required>
                    </div>
                  </div>
                ...
                <input type="hidden" name="l" value="<?php echo $row['name']; ?>">
                  ...
                  <div class="col-md-12">
                    <button type="submit" name="add" class="btn btn-a">Add Service</button>
                  </div>
                </div>
              </form>
            </div>
