...
<body style="">
  ...
  <!-- ======= Header/Navbar ======= -->
  <nav style="background-color: wheat" class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top">
    <div class="container">
...
<br><br><br>
    ...
    <div id="frame">
    <div id="sidepanel" style="background-color: white">
    ...
    <div class="content">
        <div class="contact-profile">
            <img src="../admin/admincontroller/<?php echo $row['image']; ?>" alt="" />
        ...
        <div class="messages">
            <ul>
               ...
               $st=$admin -> ret("SELECT * FROM `chat` WHERE `fp_id`='$id' ORDER BY `ch_id` ASC");

                                   while($rowsss=$st->fetch(PDO::FETCH_ASSOC))
                   ...
                   <li class="sent">
                    ...
                    <p><?php echo $rowsss['usermessage']; ?></p>
                </li>

                 <li class="replies">
                    <img src="../admin/admincontroller/<?php echo $row['image']; ?>" alt="" />
                    <p><?php echo $rowsss['providermessage']; ?></p>
                </li>
        ...
        <div class="message-input">
          <form action="usercontroller/firstproviderpage2.php" method="post">
            <div class="wrap">
            
             <input type="hidden" name="a" value="<?php echo $id; ?>">
              <input type="hidden" name="d">
             <input type="text" name="c" placeholder="Write your message..." />
            <i class="fa fa-paperclip attachment" aria-hidden="true"></i>
             <input type="text" name="b" placeholder="Enter booked user id">
            <button type="submit" name="add"><i class="fa fa-paper-plane" aria-hidden="true"></i></button>
