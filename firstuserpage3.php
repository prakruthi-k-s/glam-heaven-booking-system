...
<div class="contact-container">
  ...
  <div class="description">Feed Mode</div>
</div>
    
    <h1>Contact us</h1>
    
    
    <form id="contact-form" action="usercontroller/firstuserpage3.php" method="post">
      <label for="name">Full name</label>
  <input type="text" id="name" name="a" placeholder="Your Full Name" required>
      
       <label for="message">Message</label>
  <textarea rows="6" placeholder="Your Message" id="message" name="b" required></textarea>
