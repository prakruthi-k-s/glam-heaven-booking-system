    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
        ...
        <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="vgallery.php">View Gallery</a>
          </li>
        ...
        <div class="row">
          <div class="col-sm-12">
            ...
            <div class="sinse-box" style="background-color: wheat">
              <h3 class="sinse-title">Post Your Service Images
                <span></span>
                <br> 
              </h3>
        ...
        <div class="row">
          ...
          <div class="col-md-10 offset-md-1 col-lg-10 offset-lg-1">
            ...
            <div class="form-comments">
              ...
              <form class="form-a" action="usercontroller/gallery.php" method="post" enctype="multipart/form-data">
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <button type="submit" name="add" class="btn btn-a">Add Image</button>
                  </div>
                </div>
              </form>
            </div>
